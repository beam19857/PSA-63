...
// QueryDepartmentUser chains the current query on the DepartmentUser edge.
func (dq *DepartmentQuery) QueryDepartmentUser() *UserQuery {
...
//  WithDepartmentUser tells the query-builder to eager-loads the nodes that are connected to
// the "DepartmentUser" edge. The optional arguments used to configure the query builder of the edge.
func (dq *DepartmentQuery) WithDepartmentUser(opts ...func(*UserQuery)) *DepartmentQuery {
	query := &UserQuery{config: dq.config}
	for _, opt := range opts {
		opt(query)
	}
	dq.withDepartmentUser = query
	return dq
}
...
func (dq *DepartmentQuery) sqlAll(ctx context.Context) ([]*Department, error) {
	...
	if query := dq.withDepartmentUser; query != nil {
		...
		query.Where(predicate.User(func(s *sql.Selector) {
			s.Where(sql.InValues(department.DepartmentUserColumn, fks...))
		}))

...
func (pu *PositionUpdate) AddPositionUserIDs(ids ...int) *PositionUpdate {
	pu.mutation.AddPositionUserIDs(ids...)
	return pu
}

// AddPositionUser adds the PositionUser edges to User.
func (pu *PositionUpdate) AddPositionUser(u ...*User) *PositionUpdate {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return pu.AddPositionUserIDs(ids...)
}
...
func (pu *PositionUpdate) RemovePositionUserIDs(ids ...int) *PositionUpdate {
	pu.mutation.RemovePositionUserIDs(ids...)
	return pu
}

// RemovePositionUser removes PositionUser edges to User.
func (pu *PositionUpdate) RemovePositionUser(u ...*User) *PositionUpdate {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return pu.RemovePositionUserIDs(ids...)
}
...
func (pu *PositionUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := pu.mutation.RemovedPositionUserIDs(); len(nodes) > 0 {
	...
	if nodes := pu.mutation.PositionUserIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   position.PositionUserTable,
...
// AddPositionUserIDs adds the PositionUser edge to User by ids.
func (puo *PositionUpdateOne) AddPositionUserIDs(ids ...int) *PositionUpdateOne {
	puo.mutation.AddPositionUserIDs(ids...)
	return puo
}

// AddPositionUser adds the PositionUser edges to User.
func (puo *PositionUpdateOne) AddPositionUser(u ...*User) *PositionUpdateOne {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return puo.AddPositionUserIDs(ids...)
}
...
// RemovePositionUserIDs removes the PositionUser edge to User by ids.
func (puo *PositionUpdateOne) RemovePositionUserIDs(ids ...int) *PositionUpdateOne {
	puo.mutation.RemovePositionUserIDs(ids...)
	return puo
}

// RemovePositionUser removes PositionUser edges to User.
func (puo *PositionUpdateOne) RemovePositionUser(u ...*User) *PositionUpdateOne {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return puo.RemovePositionUserIDs(ids...)
}
...
func (puo *PositionUpdateOne) sqlSave(ctx context.Context) (po *Position, err error) {
	...
	if nodes := puo.mutation.RemovedPositionUserIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   position.PositionUserTable,
	...
	if nodes := puo.mutation.PositionUserIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   position.PositionUserTable,

...
func (du *DepartmentUpdate) AddDepartmentUserIDs(ids ...int) *DepartmentUpdate {
	du.mutation.AddDepartmentUserIDs(ids...)
	return du
}

// AddDepartmentUser adds the DepartmentUser edges to User.
func (du *DepartmentUpdate) AddDepartmentUser(u ...*User) *DepartmentUpdate {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return du.AddDepartmentUserIDs(ids...)
}
...
func (du *DepartmentUpdate) RemoveDepartmentUserIDs(ids ...int) *DepartmentUpdate {
	du.mutation.RemoveDepartmentUserIDs(ids...)
	return du
}

// RemoveDepartmentUser removes DepartmentUser edges to User.
func (du *DepartmentUpdate) RemoveDepartmentUser(u ...*User) *DepartmentUpdate {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return du.RemoveDepartmentUserIDs(ids...)
}
...
func (du *DepartmentUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := du.mutation.RemovedDepartmentUserIDs(); len(nodes) > 0 {
	...
	if nodes := du.mutation.DepartmentUserIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   department.DepartmentUserTable,
...
// AddDepartmentUserIDs adds the DepartmentUser edge to User by ids.
func (duo *DepartmentUpdateOne) AddDepartmentUserIDs(ids ...int) *DepartmentUpdateOne {
	duo.mutation.AddDepartmentUserIDs(ids...)
	return duo
}

// AddDepartmentUser adds the DepartmentUser edges to User.
func (duo *DepartmentUpdateOne) AddDepartmentUser(u ...*User) *DepartmentUpdateOne {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return duo.AddDepartmentUserIDs(ids...)
}
...
// RemoveDepartmentUserIDs removes the DepartmentUser edge to User by ids.
func (duo *DepartmentUpdateOne) RemoveDepartmentUserIDs(ids ...int) *DepartmentUpdateOne {
	duo.mutation.RemoveDepartmentUserIDs(ids...)
	return duo
}

// RemoveDepartmentUser removes DepartmentUser edges to User.
func (duo *DepartmentUpdateOne) RemoveDepartmentUser(u ...*User) *DepartmentUpdateOne {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return duo.RemoveDepartmentUserIDs(ids...)
}
...
func (duo *DepartmentUpdateOne) sqlSave(ctx context.Context) (d *Department, err error) {
	...
	if nodes := duo.mutation.RemovedDepartmentUserIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   department.DepartmentUserTable,
	...
	if nodes := duo.mutation.DepartmentUserIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   department.DepartmentUserTable,

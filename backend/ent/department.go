...
// DepartmentUserOrErr returns the DepartmentUser value or an error if the edge
// was not loaded in eager-loading.
func (e DepartmentEdges) DepartmentUserOrErr() ([]*User, error) {
	if e.loadedTypes[0] {
		return e.DepartmentUser, nil
	}
	return nil, &NotLoadedError{edge: "DepartmentUser"}
}
...
// QueryDepartmentUser queries the DepartmentUser edge of the Department.
func (d *Department) QueryDepartmentUser() *UserQuery {
	return (&DepartmentClient{config: d.config}).QueryDepartmentUser(d)
}
